...
void activateNO2(void *params)
{
    ...
    while (true)
    {
        ...
        int differential_a0a3, differential_a1a3, differential_a2a3 = {0,0,0};
        ...
        printf("voltage calibrated[0] is %f volts\tvoltage calibrated[1] is %f volts\tvoltage calibrated[2] is %f volts\n", voltage[0], voltage[1], voltage[2]);
