...
#define TAG "TASKS"
  ...
  void onConnected(void *params)
  {
    ...
    { 
      ...
      {
        ESP_LOGI(TAG,"onConnected(): Message received");
  ...
  void app_main(void)
  {
    ...
    xTaskCreate(&readSensors, "create reading", 1024 *10, NULL, 1, &readSensorsTaskHandle);
    xTaskCreate(&onConnected, "Send reading over HTTP", 1024*8, NULL, 1, &onConnectedTaskHandle);
